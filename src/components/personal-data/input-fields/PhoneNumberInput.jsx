        ...
        {isInput && (
          <button
            ...
            className={`hover:scale-110 ${
              !value ? 'text-mainGrey  cursor-not-allowed' : 'text-mainGreen '
            }`}
            disabled={!value} // Disable the button if either field is empty
          >
            <span className="flex gap-2 items-center font-onest font-medium text-sm">
              <svg
                width="16"
                height="17"
                viewBox="0 0 16 17"
